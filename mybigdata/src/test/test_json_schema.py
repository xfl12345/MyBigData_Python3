...
with open("mybigdata/src/test/test.json", "r", encoding="utf-8") as f:
    testJsonStr = json.loads(f.read())
print(testJsonStr)

with open("mybigdata/src/main/resources/json/schema/base_request_object.json", "r", encoding="utf-8") as f:
